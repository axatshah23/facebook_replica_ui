      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: const [
            ...
            Text(
              'Photos: 0/10 · Choose your listing\'s main photo first. Add more photos with multiple angles to show any damages or wear.',
            ...
            MyToggleButton(
              heading: 'Offer Shipping',
              content: 'Provide Shipping facilities to the buyer',
              icon: FontAwesomeIcons.truck,
            ),
            MyToggleButton(
              heading: 'Get automated tips and support',
              content:
                  'Get automated tips and support in Messenger\nto help you buy and sell on Marketplace.',
